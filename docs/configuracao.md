...
| `orphan_received_adopt_after_s` | int | 120 | Espera antes de outro processo adotar uma `RECEIVED` sem dono. Curto demais rouba a task de quem acabou de criá-la | `config.py:275`; `tasks/service.py:589-647` |
