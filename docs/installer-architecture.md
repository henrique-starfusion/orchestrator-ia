...
Documentação técnica do **Orquestrador IA Multiagente** (pacote `@starfusion/orchestrator`, repositório `orchestrator-ia`, v0.4.4). Descreve o instalador e aponta para o runtime.
